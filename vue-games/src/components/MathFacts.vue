      ...
      <transition name="slide">
        <template v-if="timeLeft === 0">
          <div>
            ...
            <button class="btn btn-success col-3 mx-auto d-grid gap-2 my-3 p-2 fs-5"
              v-on:click="restart()">
                Play Again
            </button>
            <button class="btn btn-danger col-3 mx-auto d-grid gap-2 my-3 p-2 fs-5"
              v-on:click="config()">
                Change Settings
            </button>
          </div>
          ...
          <div class="w-50 mx-auto">
            ...
            <div class="row" id="buttons">
              <div class="col-3 mx-auto w-auto mt-2">
                <button class="btn btn-dark bg-gradient col-4 p-1 border border-dark border-4 fs-2"
                  v-for="button in buttons" :key="button"
                  @click="setInput(button)">{{button}}</button>
                <button class="btn btn-dark bg-gradient col-8 p-1 border border-dark border-4 fs-2" id="clear-button"
